...
the `null` (0) namespace, a namespace that drivers are running on:

  - `/scheme/memory`
  - `/scheme/pipe`
-

the `root` (1) namespace, the initial namespace set up during boot:
...
- Drivers in `/etc/init_drivers.rc`
