...
- Redox Image
  ...
  - Insert Files In The Redox image Using a Recipe
...
- The "Build" shell, normally at `~/tryredox/redox` or where your base `redox` directory is.
- The "Coding" shell, at `recipes/games/redox-games/source`
## Setup Your Configuration
...
This command will create the file `build/$ARCH/your-config/redox-live.iso`, you will write this image on your USB, SSD or HDD drives and CD or DVD disks (if you have an USB device, [Popsicle is the recommended method to flash your device).
#### Full bootable image creation
