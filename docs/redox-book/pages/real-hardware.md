...
- Open the [Releases section to open the Popsicle releases page and download the `.AppImage` file.
...
- Confirm the flash process and wait until the progress bar reach 100%. If the flashing process completes with no errors, the flash was successful.
