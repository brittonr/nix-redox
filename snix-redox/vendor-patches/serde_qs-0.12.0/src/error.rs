...
// The Redox self-hosting source bundle uses a minimal guest-only thiserror
// derive shim to avoid rustc/proc-macro stalls. Spell out the conversions
// normally generated by thiserror so this crate remains independent of full
// derive expansion in the guest compiler.
