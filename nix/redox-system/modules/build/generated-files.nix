...
let
  ...
  # /login_schemes: namespace scheme list for login sessions
  # The login binary from userutils calls mkns() with a default scheme list.
  # /etc/login_schemes.toml overrides it per-user. We generate a config for
  # root that includes "proc" (needed by strace, gdbstub, and debugging tools).
  // {
